/**
 * ArticleTable.js
 * Handles Bootstrap Table configuration and selection events for articles.
 */
export class ArticleTable {
    constructor(tableSelector) {
        this.$table = $(tableSelector);
        this.$btnEdit = $('#btn-edit-article');
        this.$btnDelete = $('#btn-delete-article');
        this.$btnExport = $('#btn-export-article');
        this.$btnEnable = $('#btn-enable-article');
        this.$btnDisable = $('#btn-disable-article');
    }

    init() {
        this.initEvents();
        console.log("ArticleTable initialized");
    }
    ...
    handleSelection() {
        ...
        this.$btnExport.prop('disabled', !isSingle);
