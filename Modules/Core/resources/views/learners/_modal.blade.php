<!-- Modal -->
<div class="modal fade" id="learnerModal" tabindex="-1" role="dialog" aria-labelledby="learnerModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTitle">Ajouter un apprenant</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="learnerForm" enctype="multipart/form-data">
                @csrf
                <input type="hidden" id="learner_id" name="learner_id">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="matricule">Matricule / Identifiant <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="matricule" name="matricule" placeholder="ex: APP-2026-001" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">Min 8 caractères, majuscule, minuscule, chiffre, symbole</small>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
