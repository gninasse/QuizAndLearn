...
@section('header', 'Gestion des Apprenants')
...
<div class="card">
    ...
    <div class="card-body">
        <div id="toolbar">
            <button id="btn-add-learner" class="btn btn-primary" data-bs-toggle="tooltip" title="Ajouter un apprenant">
                <i class="fas fa-plus"></i>
            </button>
            <button id="btn-edit-learner" class="btn btn-info" disabled data-bs-toggle="tooltip" title="Modifier">
                <i class="fas fa-edit"></i>
            </button>
            <button id="btn-delete-learner" class="btn btn-danger" disabled data-bs-toggle="tooltip" title="Supprimer">
                <i class="fas fa-trash"></i>
            </button>
            <button id="btn-reset-password" class="btn btn-warning" disabled data-bs-toggle="tooltip" title="Réinitialiser MDP">
                <i class="fas fa-key"></i>
            </button>
            <button id="btn-enable-learner" class="btn btn-success" disabled data-bs-toggle="tooltip" title="Activer">
                <i class="fas fa-check"></i>
            </button>
            <button id="btn-disable-learner" class="btn btn-secondary" disabled data-bs-toggle="tooltip" title="Désactiver">
                <i class="fas fa-ban"></i>
            </button>
        </div>
        <table id="learners-table"
               data-toggle="table"
               data-url="{{ route('cores.learners.data') }}"
...
<script type="module" src="{{ asset('js/modules/core/learners/index.js') }}"></script>
@endpush
