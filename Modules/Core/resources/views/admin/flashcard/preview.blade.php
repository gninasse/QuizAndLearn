...
@section('title', 'Aperçu du Paquet - ' . $deck->titre)
...
<div class="preview-container">
  ...
  <div class="simulator-toolbar d-flex align-items-center justify-content-between p-3 bg-white border-bottom shadow-sm">
    <div class="d-flex align-items-center gap-2">
      <a href="{{ route('cores.editor.flashcards.edit', $deck->id) }}" class="btn btn-sm btn-outline-secondary" style="border-radius: 8px;">
        <i class="bi bi-arrow-left me-1"></i> Retour à l'éditeur
      </a>
      <h5 class="mb-0 ms-2 fw-bold text-truncate" style="max-width: 250px; color: var(--green-dark);">Aperçu : {{ $deck->titre }}</h5>
    </div>
    ...
    <div class="device-wrapper laptop" id="deviceWrapper">
      <div class="device-bezel">
        ...
        <div class="device-content">
          <iframe src="{{ route('cores.editor.flashcards.preview-iframe', $deck->id) }}" id="previewIframe" title="Flashcard Preview"></iframe>
        </div>
