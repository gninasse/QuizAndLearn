...
@section('header', 'Gestion des Formateurs')
...
<div class="card">
    ...
    <div class="card-body">
        <div id="toolbar">
            <button id="btn-add-trainer" class="btn btn-primary" data-bs-toggle="tooltip" title="Ajouter un formateur">
                <i class="fas fa-plus"></i>
            </button>
            <button id="btn-edit-trainer" class="btn btn-info" disabled data-bs-toggle="tooltip" title="Modifier">
                <i class="fas fa-edit"></i>
            </button>
            <button id="btn-delete-trainer" class="btn btn-danger" disabled data-bs-toggle="tooltip" title="Supprimer">
                <i class="fas fa-trash"></i>
            </button>
            <button id="btn-reset-password" class="btn btn-warning" disabled data-bs-toggle="tooltip" title="Réinitialiser MDP">
                <i class="fas fa-key"></i>
            </button>
            <button id="btn-enable-trainer" class="btn btn-success" disabled data-bs-toggle="tooltip" title="Activer">
                <i class="fas fa-check"></i>
            </button>
            <button id="btn-disable-trainer" class="btn btn-secondary" disabled data-bs-toggle="tooltip" title="Désactiver">
                <i class="fas fa-ban"></i>
            </button>
        </div>
        <table id="trainers-table"
               data-toggle="table"
               data-url="{{ route('cores.trainers.data') }}"
            ...
            <thead>
                <tr>
                    ...
                    <th data-field="specialty" data-sortable="true">Spécialité</th>
...
<script type="module" src="{{ asset('js/modules/core/trainers/index.js') }}"></script>
@endpush
